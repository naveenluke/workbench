...
#
# Install IJulia as naveen and then move the kernelspec out
# to the system share location. Avoids problems with runtime UID change not
# taking effect properly on the .local folder in the naveen home dir.
...
# give naveen sudo permissions
RUN sed -i -e "s/Defaults    requiretty.*/ #Defaults    requiretty/g" /etc/sudoers
RUN echo "naveen ALL= (ALL) NOPASSWD: ALL" >> /etc/sudoers.d/naveen
